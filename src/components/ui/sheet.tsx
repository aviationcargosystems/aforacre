...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/40 transition-opacity duration-200 supports-backdrop-filter:backdrop-blur-xs data-[state=closed]:opacity-0 data-[state=open]:opacity-100",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          // Slide is driven by an explicit transition + data-[state] variants rather than
          // tw-animate-css's keyframe utilities — those leave the panel stuck at its
          // off-screen "enter" position instead of settling to translate-0 on this stack.
