...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[1.5rem] border-t border-border/70 bg-muted/45 p-(--card-spacing)",
        className
      )}
      {...props}
    />
